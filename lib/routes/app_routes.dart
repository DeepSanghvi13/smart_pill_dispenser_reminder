...
class AppRoutes {
  ...
  static const String caretakerHome = '/caretaker';
  ...
  static const String reminderTroubleshooting =
      '/manage/reminder-troubleshooting';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case caretakerHome:
        return MaterialPageRoute(
            builder: (_) => const CaretakerWebpageScreen());
      case createProfile:
      ...
      case addMedication:
        ...
        return MaterialPageRoute(
          builder: (_) =>
              AddMedicationScreen(medicine: args is Medicine ? args : null),
        );
      case expiryCalendar:
        final args = settings.arguments;
