...
class CaretakerWebpageScreen extends StatefulWidget {
  const CaretakerWebpageScreen({super.key});

  @override
  State<CaretakerWebpageScreen> createState() => _CaretakerWebpageScreenState();
}

class _CaretakerWebpageScreenState extends State<CaretakerWebpageScreen> {
      ...
      child: _panel(
        ...
        child: Column(
          children: const [
            ...
            _SettingsRow(
                label: 'Caretaker Data Source', value: 'MongoDB API endpoints'),
          ],
        ),
      ),
    );
